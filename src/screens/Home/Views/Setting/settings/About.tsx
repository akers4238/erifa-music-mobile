...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl('https://github.com/akers4238/lx-music-mobile#readme')
  }
  const openIssuePage = () => {
    void openUrl('https://github.com/akers4238/lx-music-mobile/issues?q=is%3Aissue+')
  }
  const openGHReleasePage = () => {
    void openUrl('https://github.com/akers4238/lx-music-mobile/releases')
  }
  const openFAQPage = () => {
    void openUrl('https://akers4238.github.io/lx-music-doc/mobile/faq')
  }
  // const openIssuesPage = () => {
  //   openUrl('https://github.com/akers4238/lx-music-mobile/issues')
  // }
  const openPactModal = () => {
    showPactModal()
  }
  const openPartPage = () => {
    void openUrl('https://github.com/akers4238/lx-music-mobile#%E9%A1%B9%E7%9B%AE%E5%8D%8F%E8%AE%AE')
  }
    ...
    <Section title={t('setting_about')}>
      <View style={styles.part}>
        ...
        <TouchableOpacity onPress={openHomePage}>
          <Text style={textLinkStyle}>https://github.com/akers4238/lx-music-mobile</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.part}>
